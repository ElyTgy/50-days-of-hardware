...
- **CD40106 (hex Schmitt inverter)** — needed for day(s) [1](https://hardware.ellietaghavi.com/llm/day-01.md), [10](https://hardware.ellietaghavi.com/llm/day-10.md), [17](https://hardware.ellietaghavi.com/llm/day-17.md) — [link](https://leeselectronic.com/en/product/71863-ic-cmos-40106-hex-inverting-schmitt-triggernot.html)
  Schmitt-trigger inverter used for relaxation oscillator and ring oscillator
- **CD4046 (CMOS PLL)** — needed for day(s) [23](https://hardware.ellietaghavi.com/llm/day-23.md) — [link](https://leeselectronic.com/en/product/7213-7213ICCMOS4046PLLWITHVCO.html)
...
- **Electrolytic capacitor 1uF (5-pack)** — needed for day(s) general stock — [link](https://leeselectronic.com/en/product/8700-8700ELECTROLYTICCAP50V1UF10PCS.html)
  General-purpose electrolytic capacitor stock for RC timing, filtering, and decoupling exercises
- **Ground plane (tin lid) + wire** — needed for day(s) [39](https://hardware.ellietaghavi.com/llm/day-39.md), [40](https://hardware.ellietaghavi.com/llm/day-40.md) — [link](https://leeselectronic.com/en/product/225019-hook-up-wire-14awg-solid-white-per-foot.html)
  Radial/image ground plane and radiating element for the cut monopole
- **Inductors (10 uH - 1 mH)** (min qty: 2) — needed for day(s) [6](https://hardware.ellietaghavi.com/llm/day-06.md), [7](https://hardware.ellietaghavi.com/llm/day-07.md), [27](https://hardware.ellietaghavi.com/llm/day-27.md) — [link](https://leeselectronic.com/en/category/3051-inductors)
...
- **IRLZ44N (logic-level power MOSFET)** — needed for day(s) [6](https://hardware.ellietaghavi.com/llm/day-06.md), [15](https://hardware.ellietaghavi.com/llm/day-15.md) — [link](https://leeselectronic.com/en/product/71248-mosfet-irlz44npbf-55v-47a-n-channel-22mohm-to-220.html)
  Low-side power switch for inductor kickback and gate-charge / switching-loss study
- **L298N dual H-bridge module (DRV8833 substitute)** — needed for day(s) [30](https://hardware.ellietaghavi.com/llm/day-30.md) — [link](https://leeselectronic.com/en/product/71208-h-bridge-l298n-dual-full-bridge-driver-motor.html)
...
- **RG58 coax ~5 m (+ SMA pigtails)** — needed for day(s) [34](https://hardware.ellietaghavi.com/llm/day-34.md), [38](https://hardware.ellietaghavi.com/llm/day-38.md) — [link](https://leeselectronic.com/en/product/213980-rf-extension-cable-rg58-u-sma-m-f-10-meter.html)
...
- **BS250P (P-channel MOSFET)** — needed for day(s) [17](https://hardware.ellietaghavi.com/llm/day-17.md) — [link](https://www.digikey.com/en/products/result?keywords=BS250P)
  PMOS pull-up paired with the 2N7000 NMOS to build a discrete CMOS inverter from scratch
- **function generator**
- **INA219 current-sense breakout** — needed for day(s) [31](https://hardware.ellietaghavi.com/llm/day-31.md), [32](https://hardware.ellietaghavi.com/llm/day-32.md) — [link](https://www.digikey.com/en/products/detail/adafruit-industries-llc/904/5353628)
  Digital high-side/low-side current + voltage monitor for motor and battery logging
- **NanoVNA-H4 (+ SMA cables/adapters + SOL cal kit)** — needed for day(s) [5](https://hardware.ellietaghavi.com/llm/day-05.md), [7](https://hardware.ellietaghavi.com/llm/day-07.md), [38](https://hardware.ellietaghavi.com/llm/day-38.md), [39](https://hardware.ellietaghavi.com/llm/day-39.md), [40](https://hardware.ellietaghavi.com/llm/day-40.md) — [link](https://www.aliexpress.com/item/1005003551867442.html)
  Vector network analyzer to measure SRF, S11, Smith-chart impedance, and antenna resonance
- **scope**
- **SMA jack / connector** — needed for day(s) [39](https://hardware.ellietaghavi.com/llm/day-39.md) — [link](https://www.digikey.com/en/products/detail/linx-technologies-inc/CONSMA008/CONSMA008-ND/1577219)
